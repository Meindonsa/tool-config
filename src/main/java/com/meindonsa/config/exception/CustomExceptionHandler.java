...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleAllExceptions(Exception ex, WebRequest request) {
        return new ResponseEntity(
                new ErrorResponse(Messages.ERR_TECHNICAL, processError(ex)),
    ...
    public final ResponseEntity<Object> handleRecordNotFoundException(
        ...
        return new ResponseEntity(
                new ErrorResponse(Messages.ERR_UNKNOWN, processError(ex)), HttpStatus.NOT_FOUND);
    }
    ...
    public final ResponseEntity<Object> handleForbiddenException(
        ...
        return new ResponseEntity(
                new ErrorResponse(Messages.ERR_FORBIDDEN, processError(ex)), HttpStatus.FORBIDDEN);
    }
    ...
    public final ResponseEntity<Object> handleInvalidInputException(
        ...
        return new ResponseEntity(
                new ErrorResponse(Messages.ERR_INVALID_OPERATION, processError(ex)),
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
            ...
            WebRequest request) {
        return new ResponseEntity(
                new ErrorResponse(Messages.ERR_VALIDATION_FAILED, processError(ex)),
